...
filefolder = "/Users/nomoredrama/Downloads/"
filepaths = pathlib.Path(filefolder).glob('*.nc')
...
for filepath in filepaths:
    ...
    ds_array = dataset['radiance'].values
    ds_array = ds_array[:, :, 0]
    export_result_to_netcdf(ds_array, filepath, output_folder)
