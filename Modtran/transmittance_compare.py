...
emit_bands,convoluved_trans1 = get_simulated_satellite_transmittance(transmittance_path1,emit_channel_path,1500,2500)
...
ln1 = ax1.plot(emit_bands, enhanced_trans1, label='1.5*enhanced transmittance', color='gray', alpha=0.6)
ln2 = ax1.plot(emit_bands, enhanced_trans2, label='2*enhanced transmittance', color='blue', alpha=0.6)
