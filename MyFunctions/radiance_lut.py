...
_,base_radiance = nf.get_simulated_satellite_radiance(basefilepath,channels_path,2100,2500)
...
def build_lookup_table(enhancements):
    ...
    for enhancement in enhancements:
        ...
        bands, spectrum = nf.get_simulated_satellite_radiance(filepath, ahsi_channels_path, 900, 2500)    
