# 循环生成100个新文件tp5  用于不同情况甲烷浓度增强的 模拟
for n in range(1, 101):
    # 打开原始文件进行读取
    with open("C:\\Users\\RS\\Desktop\\AHSI\\AHSI_0.tp5", 'r', encoding='utf-8') as file:
        lines = file.readlines()

    # 修改第九行和第十一行的内容
    for line_number in [8, 11]:  # 第九行和第十一行对应的索引分别为8和10
        ...
        print(original_line[:20])
        print(modified_line)
        lines[line_number] = modified_line + '\n'  # 更新行内容
    # 将修改后的内容写入新文件
    file_name = f"C:\\Users\\RS\\Desktop\\AHSI\\AHSI_{n*100}.tp5"
