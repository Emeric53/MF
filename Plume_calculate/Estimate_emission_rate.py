...
from Integrated_mass_enhancement import emission_estimate
import os
import geopandas as gpd


def wind_speed(plume_name):
    """
    this function is used to calculate the wind speed of the nearest point of the plume
...
def read_tif_array(tif_path):
    # read the array of the plume
    plume_data = gdal.Open(tif_path, gdal.GA_ReadOnly)
    return plume_data.ReadAsArray()


# set the filepath of methane plume image or the enhancement of methane
plume_folder = r"I:\甲烷烟羽产品\EMIT_Plumes_China"
plume_names = ['EMIT_L2B_CH4PLM_001_20220818T070105_000508.tif',
...
for plume_name in plume_names:
    ...
    emission_rate_result = emission_estimate(plume_data, pixel_resolution=30, windspeed_10m=windspeed, slope=0.38,
                                             intercept=0.41, enhancement_unit='ppmm')
